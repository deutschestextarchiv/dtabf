...
public class InsertTableOperation implements AuthorOperation {
  ...
  public void doOperation(AuthorAccess authorAccess, ArgumentsMap args)
    ...
    if (tableInfo != null) {
      String tableString = "";
      tableString+="<table xmlns=\"http://www.tei-c.org/ns/1.0\">";

      if(tableInfo.getTitle() != null) {
        tableString+="<head>"+tableInfo.getTitle()+"</head>";
      }
      ...
      authorAccess.getDocumentController().insertXMLFragmentSchemaAware(tableString, authorAccess.getEditorAccess().getCaretOffset());
    } else {
    }
  }
  ...
  public String getDescription() {
    return "Inserts a table with predescribed row and col size";
  }
}
