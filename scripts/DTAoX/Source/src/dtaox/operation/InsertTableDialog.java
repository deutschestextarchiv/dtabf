...
public class InsertTableDialog extends SATableCustomizerDialog {
  ...
  @Override
  protected String getDefaultAlignValue(int tableModel) {
    return null;
  }

  @Override
  protected String getDefaultColsepValue(int tableModel) {
    return null;
  }

  @Override
  protected String[] getAlignValues(int tableModel) {
    return null;
  }

  @Override
  protected String[] getColsepValues(int tableModel) {
    return null;
  }

  @Override
  protected String getDefaultRowsepValue(int tableModel) {
    return null;
  }

  @Override
  protected String[] getRowsepValues(int tableModel) {
    return null;
  }
}